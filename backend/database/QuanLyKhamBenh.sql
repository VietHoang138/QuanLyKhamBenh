...
/*=========================================================
17. BẢNG HOÁ ĐƠN VIỆN PHÍ & DỮ LIỆU MẪU
=========================================================*/
...
-- Thêm dữ liệu mẫu vào bảng BaoHiemYTe
...
-- Chèn hóa đơn cho các bệnh án đã có sẵn
...
VALUES 
('HD001', 'BA001', 'BN001', 'BS001', 300000, 450000, 0, 750000, 80, 600000, 150000, NULL, N'Chưa thanh toán', DATEADD(day, -3, GETDATE()), NULL),
('HD002', 'BA002', 'BN002', 'BS002', 350000, 105000, 50000, 505000, 0, 0, 505000, N'Tiền mặt', N'Đã thanh toán', DATEADD(day, -2, GETDATE()), DATEADD(day, -2, GETDATE())),
('HD003', 'BA003', 'BN003', 'BS003', 250000, 225000, 0, 475000, 95, 451250, 23750, NULL, N'Chưa thanh toán', DATEADD(day, -1, GETDATE()), NULL),
('HD004', 'BA004', 'BN004', 'BS004', 280000, 150000, 100000, 530000, 0, 0, 530000, N'Chuyển khoản', N'Đã thanh toán', DATEADD(hour, -12, GETDATE()), DATEADD(hour, -11, GETDATE())),
('HD005', 'BA005', 'BN005', 'BS005', 400000, 0, 0, 400000, 100, 400000, 0, N'Chuyển khoản', N'Đã thanh toán', DATEADD(hour, -2, GETDATE()), DATEADD(hour, -2, GETDATE()));
GO